...
const (
	TestService_Ping_FullMethodName = "/grpc.test.TestService/Ping"
)
...
func (c *testServiceClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Pong, error) {
...
func (UnimplementedTestServiceServer) Ping(context.Context, *Empty) (*Pong, error) {
...
func _TestService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).Ping(ctx, req.(*Empty))
	}
